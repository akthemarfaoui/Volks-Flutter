  ...
  Future<User> getUser(String route,[dynamic args]) async
{
  ...
  if(response.statusCode == 200)
    {
      if(response.contentLength == 2 ) // yaaani l body is not empty (!= []) donc lkina objet
          {
    ...
    throw Exception("Thabet ya bhim => status code= "+response.statusCode.toString() + " URI = " + response.request.url.toString() );
