...
class ProfilePageState extends State<ProfilePage>
    with SingleTickerProviderStateMixin implements IPofileView {
  bool _status = true;
...
@override
  ...
  void UpdateProfilePage(ProfileViewModel profileViewModel) {
    ...
    if(this.widget.didUpdated)
      {
        print("ssss");
        AlertDialog alert = new AlertDialog(title: Text("User Updating.."),content: Text("User Updated Successfully"),actions: [
          FlatButton(
              onPressed: (){
